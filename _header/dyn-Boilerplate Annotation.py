...
#Imports the standard IronPython libraries, which cover everything from servers and
...
#.NET class for handling array information

from System.Collections.Generic import * 
#Lets you handle generics. Revit's API
...
#More loading of Dynamo's Revit libraries
...
#Dynamo's classes for handling Revit documents
